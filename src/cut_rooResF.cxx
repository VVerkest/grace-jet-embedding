...
using namespace std;
void cut_rooResF(events& dat, string _options) {
    // Start of 
    cout << " Running fn \"cut_rooResF\"" << endl;
    ...
    ioMsgTree msg{false};
    msg.slurp_file("src/cut_rooResF.cxx");
    msg.write();
    ...
    while (dat.next()) {
        ...
        if (F_matcher.do_matching(dat.pthat_bin)) {
    ...
    dat.log << " Cut for out of bounds: " << endl;
    dat.log << "        N-keep N-cup    ratio cut" << endl;
    cout << " Cut for out of bounds: " << endl;
