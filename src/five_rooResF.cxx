...
using namespace std;
void five_rooResF(events& dat, string _options) {
    // Start of 
    cout << " Running fn \"five_rooResF\"" << endl;
    ...
    ioMsgTree msg{false};
    msg.slurp_file("src/five_rooResF.cxx");
    msg.write();
    ...
    ioJetMatcher F_matcher { "F", Xsec, edge_file, "jetpt_bigbytwos", "jetpt_bigbytwos" };
    ioJetMatcher C_matcher { "C", Xsec, edge_file, "jetpt_bigbytwos", "jetpt_bigbytwos" };
    ioJetMatcher matcher_hiEA { 
        "match_hiEA", Xsec, edge_file, 
        "jetpt_bigbytwos", "jetpt_bigbytwos" };
