...
using namespace std;
void sane_bins(events& dat, string _options) {
    // Start of 
    cout << " Running fn \"sane_bins\"" << endl;
    ...
    ioMsgTree msg{false};
    msg.slurp_file("src/sane_bins.cxx");
    msg.write();
    ...
    cout << " read bbc_limits ";
    for (auto& v : bbc_limits) cout << " " << v; cout << endl;
